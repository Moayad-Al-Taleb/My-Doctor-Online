...
<body class="main-body app sidebar-mini">
    ...
    <!-- /Loader -->
    @include('Dashboard.User.layouts.main-sidebar')
    <!-- main-content -->
    <div class="main-content app-content">
        @include('Dashboard.User.layouts.main-header')
        <!-- container -->
        <div class="container-fluid">
            @yield('page-header')
            @yield('content')
            @include('Dashboard.User.layouts.sidebar')
            @include('Dashboard.User.layouts.models')
            @include('Dashboard.User.layouts.footer')
            @include('Dashboard.User.layouts.footer-scripts')
</body>

            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Illness:</strong> {{ $article->illness->name }}</p>
                        <p><strong>Health Category:</strong> {{ $article->healthCategory->name }}</p>
                        <!-- Check if article has files -->
                        @if ($article->articleFiles->isNotEmpty())
                            <div id="carousel{{ $article->id }}" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    @foreach ($article->articleFiles as $key => $file)
                                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                            ...
                                            @elseif ($file->type == 2)
                                                <video controls>
                                                    <source
                                                        src="{{ asset('Dashboard/Attachments/videos/' . $file->file) }}"
                                                        type="video/mp4">

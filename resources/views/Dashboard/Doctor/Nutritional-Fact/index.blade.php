        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a href="{{ route('Doctor.NutritionalFacts.create') }}" class="btn btn-primary" role="button"
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">Fact</th>
                            ...
                            <tbody>
                                @foreach ($nutritionalFacts as $nutritionalFact)
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('Doctor.NutritionalFacts.edit', $nutritionalFact->id) }}">
                                                    ...
                                                    <!-- رابط لعرض بيانات -->
                                                    <a class="dropdown-item"
                                                        href="{{ route('Doctor.NutritionalFacts.show', $nutritionalFact->id) }}">
                                    ...
                                    @include('Dashboard.Doctor.Nutritional-Fact.delete')
                                    @include('Dashboard.Doctor.Nutritional-Fact.update_status')
                                    @include('Dashboard.Doctor.Nutritional-Fact.delete_select')
                                @endforeach
                            </tbody>
                        </table>
                    </div>

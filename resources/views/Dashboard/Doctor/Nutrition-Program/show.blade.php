...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <a href="{{ route('Doctor.NutritionPrograms.index') }}">
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a href="{{ route('Doctor.NutritionProgramMeals.create', $nutritionProgram->id) }}"
                        class="btn btn-primary" role="button" aria-pressed="true">Add nutrition
                        program
                        meal</a>
                            ...
                            <tbody>
                                @foreach ($nutritionProgramMeals as $nutritionProgramMeal)
                                    <tr>
                                        ...
                                        <td>{{ $nutritionProgramMeal->created_at->diffforhumans() }}</td>
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-toggle="modal"
                                                href="#delete{{ $nutritionProgram->id }}{{ $nutritionProgramMeal->id }}"><i
                                                    class="las la-trash"></i></a>
                                            <!-- رابط لعرض بيانات -->
                                            <a class="modal-effect btn btn-sm btn-primary"
                                                href="{{ route('Doctor.NutritionProgramMeals.show', ['NutritionProgram' => $nutritionProgram->id, 'NutritionProgramMeal' => $nutritionProgramMeal->id]) }}"><i

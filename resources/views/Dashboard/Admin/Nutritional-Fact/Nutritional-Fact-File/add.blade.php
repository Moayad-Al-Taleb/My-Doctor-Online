...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Dashboard/admin/pages/nutritional_facts_trans.nutritional_fact_files') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    {{ trans('Dashboard/admin/pages/nutritional_facts_trans.add_nutritional_fact_file') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{ route('Doctor.NutritionalFactFiles.store') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-4">
                                    <label for="file" class="form-label mg-b-0">{{ trans('Dashboard/admin/pages/nutritional_facts_trans.file') }}</label>
                                </div>

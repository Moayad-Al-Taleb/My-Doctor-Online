...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Admin.Doctors.update', 'test') }}" method="post" autocomplete="off"
                        enctype="multipart/form-data">
                        {{ method_field('put') }}
                        @csrf

                        <input name="id" class="form-control" type="hidden" value="{{ $doctor->id }}">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $doctor->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    <textarea name="address" id="address" cols="30" rows="10" class="form-control">{{ $doctor->address }}</textarea>
                                </div>
                            </div>

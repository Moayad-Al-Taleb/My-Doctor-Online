        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a href="{{ route('Admin.Doctors.create') }}" class="btn btn-primary" role="button"
                                ...
                                @foreach ($doctors as $doctor)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <img src="{{ Url::asset('Dashboard/img/DoctorDefault.jpg') }}"
                                        ...
                                        <td>
                                            {{ $doctor->telegram_number == null ? '-' : $doctor->telegram_number }}
                                        </td>
                                    ...
                                    @include('Dashboard.Admin.Doctor.delete')
                                    @include('Dashboard.Admin.Doctor.update_password')
                                    @include('Dashboard.Admin.Doctor.update_status')
                                    @include('Dashboard.Admin.Doctor.delete_select')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
